...
<body>
    ...
    <!-- <?php foreach($phoneArray['Samsung'] as $value): ?>
    <?php var_dump($value);?>
    <?php endforeach; ?> -->
...
<div class="container">
        ...
        <?php foreach($samsungOrHuawei as $data): ?>
            <div class="card">
                ...
                <p>OS: <?php print $data['OS'] ?></p> 
                <p>Price: <?php print $data['price'] ?></p>
            </div>
        <?php endforeach; ?>
        <?php endforeach; ?>
</div>
        ...
        <!-- <?php foreach($weekTemp as $dayTemp): ?>

        <div class="termo">
            <?php if($dayTemp >= 0): ?>
                <div class="plus" style="height: <?php print $dayTemp?>"><?php print $dayTemp?> </div>
            <?php else: ?>
                <div class="minus" style="height: <?php print $dayTemp?>"><?php print $dayTemp?> </div>  
            <?php endif; ?>  
        </div>
